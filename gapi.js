const Retrier = class {
  ...
  async function clearSheet(shtId, ssId = spreadsheetId) { // 
    ...
    const retrier = new Retrier(options);
    let response = await retrier
      .resolve(async attempt => gapi.client.sheets.spreadsheets.batchUpdate({spreadsheetId: spreadsheetId, resource: resource}))
      .then(
        result => {console.log(result);return result},
        error =>  {console.log(error) ;return error}
      );
  ...
  async function listGmailThreads(params) { // **
    ...
    const retrier = new Retrier(options);
    let response = await retrier
      .resolve(async attempt => await gapi.client.gmail.users.threads.list(params))
      .then(
          result => {console.log('result', result);return result},
          error =>  {console.log(error) ;return error}
      );
  ...
  async function batchDeleteGmail(params) {
    ...
    const retrier = new Retrier(options);
    let response = await retrier
      .resolve(async attempt => await gapi.client.gmail.users.messages.batchDelete(params))
      .then(
          result => {console.log('result', result);return result},
          error =>  {console.log(error) ;return error}
      );
  ...
  async function searchPhotos(params) { // 
    ...
    const retrier = new Retrier(options);
    let response = await retrier
      .resolve(async attempt => await gapi.client.photoslibrary.mediaItems.search(params))
      .then(
          result => {console.log('result', result);return result},
          error =>  {console.log(error) ;return error}
      );
  ...
  async function createPhotos(params) { // 
    ...
    const retrier = new Retrier(options);
    let response = await retrier
      .resolve(async attempt => await gapi.client.photoslibrary.mediaItems.batchCreate(params))
      .then(
          result => {console.log('result', result);return result},
          error =>  {console.log(error) ;return error}
      );
  ...
  async function createAlbum(title) {
    ...
    const retrier = new Retrier(options);
    let response = await retrier
      .resolve(async attempt => await gapi.client.photoslibrary.albums.create({
              "album": {
                "title":title
              }
      })
  ...
  async function listAlbums(params) {
    ...
    const retrier = new Retrier(options);
    let response = await retrier
      .resolve(async attempt => await gapi.client.photoslibrary.albums.list(params)
    )
      .then(
          result => {console.log('result', result);return result},
          error =>  {console.log(error) ;return error}
